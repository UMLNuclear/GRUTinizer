...
std::ostream& operator<<(std::ostream& os, const TRawEvent::TrackedGammaRay &gam) {
  os << "esum      = "<<std::setw(10)<<gam.esum << std::endl;
  os << "ndet      = "<<std::setw(10)<<gam.ndet << std::endl;
  os << "fom       = "<<std::setw(10)<<gam.fom << std::endl;
  os << "tracked   = "<<std::setw(10)<<gam.tracked << std::endl;
  os << "timestamp = "<<std::setw(10)<<gam.timestamp << std::endl;
  os << "x0        = "<<std::setw(10)<<gam.x0 << std::endl;
  os << "y0        = "<<std::setw(10)<<gam.y0 << std::endl;
  os << "z0        = "<<std::setw(10)<<gam.z0 << std::endl;
  os << "e0        = "<<std::setw(10)<<gam.e0 << std::endl;
  os << "x1        = "<<std::setw(10)<<gam.x1 << std::endl;
...
/*
std::ostream& operator<<(std::ostream& os, const TRawEvent::GEBTrackedInteractionPoint &fInt) {
  std::streamsize ss = std::cout.precision();
  os << "\t" << "xx          = "<<std::setw(10) << fInt.xx << std::endl;
  os << "\t" << "yy          = "<<std::setw(10) << fInt.yy << std::endl;
  os << "\t" << "zz          = "<<std::setw(10) << fInt.zz << std::endl;
  os << "\t" << "edet        = "<<std::setw(10) << fInt.edet << std::endl;      
  os << "\t" << "order       = "<<std::setw(10) << fInt.order << std::endl;
  os << "\t" << "timestamp   = "<<std::setw(10) << fInt.timestamp << std::endl;
  os << "\t" << "shellHitPos = "<<std::setw(10) << fInt.shellHitPos << std::endl;
  os << "\t" << "detno       = "<<std::setw(10) << fInt.detno << std::endl;
  return os;
}
...
std::ostream& operator<<(std::ostream& os, const TRawEvent::GEBBankType3 &bank) {
  ...
  os << "************************" << std::endl;
  os << "vaild           = " <<std::setw(10) << bank.vaild << std::endl;
  os << "ndet            = " <<std::setw(10) << bank.ndet << std::endl;
  os << "tracked         = " <<std::setw(10) << bank.tracked << std::endl;
  os << "fom             = " <<std::setw(10) << bank.fom << std::endl;
  os << "esum            = " <<std::setw(10) << bank.esum << std::endl;
  os << "trackno         = " <<std::setw(10) << bank.trackno << std::endl;
  os << "bestPermutation = " <<std::setw(10) << bank.bestPermutation << std::endl;
  os << "processed       = " <<std::setw(10) << bank.processed << std::endl;
  for(int x=0;x<MAX_INTPTS;x++)//x<bank.ndet;x++)
    os << "\t" << bank.intpts[x];
  os << "************************" << std::endl;
