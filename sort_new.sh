...
for i in $FILES
do
  echo grutinizer -qH $i ./lib/libMakee15130_v7.so e15130_latest.val e15130_latest.cal zcuts_noReactions.cuts -o /dev/null
  grutinizer -qH $i ./lib/libMakee15130_v7.so e15130_latest.val e15130_latest.cal zcuts_noReactions.cuts -o /dev/null
done
